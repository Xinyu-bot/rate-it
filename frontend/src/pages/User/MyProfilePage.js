    ...
    async (tab) => {
      ...
      try {
        ...
        if (response.data?.code === 0) {
          ...
          console.error(`Failed to fetch ${tab}:`, response.message);
        }
        ...
        <div className="tab-content">
          {activityLoading ? (
            ...
            <>
              ...
              {(activeTab === "upvotes" || activeTab === "downvotes") && (
                <div className="votes-list">
                  {votes.length > 0 ? (
                    votes.map((vote) => (
                      <div key={vote.id} className="vote-item">
                        <div className="vote-type">
                          <span
                            className={
                              vote.type === "upvote" ? "upvote" : "downvote"
                            }
                          >
                    ...
                    <div className="empty-state">
                      <p>
                        You haven't{" "}
                        {activeTab === "upvotes" ? "upvoted" : "downvoted"} any
                        threads yet.
                      </p>
                    </div>
                  )}
